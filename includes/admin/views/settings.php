            ...
            <form id="ace-redis-settings-form" method="post" class="ace-redis-form">
                ...
                <div id="sitemaps" class="tab-content">
                    ...
                    <div class="settings-form">
                        ...
                        <div class="setting-row"><div class="setting-label"><label for="sitemap_enable_sitemap_cache">Enable sitemap cache</label></div><div class="setting-field"><input type="checkbox" name="ace_sitemap_powertools_options[enable_sitemap_cache]" id="sitemap_enable_sitemap_cache" value="1" <?php checked(!empty($sitemap_options['enable_sitemap_cache'])); ?> /><p class="description">Cache sitemap index and sitemap pages for faster cold loads.</p></div></div>
